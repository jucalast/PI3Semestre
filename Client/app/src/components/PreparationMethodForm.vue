    ...
    <form @submit.prevent="submitForm">
      <div class="dados-imagem">
        <div class="dados">
          ...
          <div class="form-group">
            <label v-if="isEditMode" for="quantidade_estoque">
              Quantidade em Estoque:
            </label>
            <input
              id="quantidade_estoque"
              v-model.number="localProduct.quantidade_estoque"
              type="number"
          ...
          <div class="form-group">
            ...
            <input
              id="tipo_preparo"
              v-model="localProduct.metodoPreparo.tipo_preparo"
          ...
          <div class="form-group">
            ...
            <input
              id="material"
              v-model="localProduct.metodoPreparo.material"
          ...
          <div class="form-group">
            ...
            <input
              id="acessorios"
              v-model="localProduct.metodoPreparo.acessorios"
          ...
          <div class="form-group">
            ...
            <select
              id="complexidade"
              v-model="localProduct.metodoPreparo.complexidade"
              required
            >
          ...
          <div class="form-group">
            ...
            <input
              id="marca"
              v-model="localProduct.metodoPreparo.marca"
              placeholder="Marca"
            />
          </div>
        </div>
        ...
        <div class="imagenanddrop">
          ...
          <div class="image-preview" v-if="localProduct.imagens.length">
            <div
              v-for="(image, index) in localProduct.imagens"
              :key="index"
      ...
      <button
        :class="['enviar', { disabled: !isFormValid || !isFormChanged }]"
        type="submit"
        :disabled="!isFormValid || !isFormChanged"
      >
        {{
          isEditMode ? 'Atualizar método de preparo' : 'Criar método de preparo'
        }}
      </button>
    </form>
  </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      checkFormChanges() {
        this.isFormChanged =
          JSON.stringify(this.localProduct) !== JSON.stringify(this.product);
      },
    },
  };
</script>
