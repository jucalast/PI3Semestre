...
<div class="c3">
        <h4>Detalhes do Café Especial</h4>
        ...
        <input v-model="product.cafeEspecial.dataTorra" type="date" placeholder="Data de Torra" />
        <input v-model="product.cafeEspecial.dataValidade" type="date" placeholder="Data de Validade" />
    </div>   
