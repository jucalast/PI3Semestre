...
public class AddressService {
    ...
    /**
     * Repositório de endereços utilizado para realizar operações de persistência
     * dos endereços no banco de dados.
     */
    @Autowired
     ...
     *
     * Este método associa um novo endereço a um usuário com base no seu ID. 
     ...
     *
     * Este método retorna uma lista de todos os endereços presentes no banco de dados.
     *
